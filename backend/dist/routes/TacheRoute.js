...
const router = Router();
router.patch("/:id/audio", upload.single("audio"), PermissionMiddleware.verifierDroit(Droit.MODIFIER), TacheController.uploadAudio);
...
router.delete("/:id", PermissionMiddleware.verifierDroit(Droit.MODIFIER), TacheController.delete);
